...
export const zh: Translations = {
  ...
  common: {
    ...
    search: {
      openLabel: "搜索",
      inputLabel: "搜索本网站",
      placeholder: "搜索检验项目、疫苗、页面…",
      shortcutHint: "⌘K",
      noResults: "找不到相关结果。请尝试其他关键词,或致电 +60 3-2181 8686 联系我们。",
      resultsHint: "↑↓ 选择 · Enter 前往 · Esc 关闭",
      groupScreening: "健康检查与检验项目",
      groupVaccinations: "疫苗接种",
      groupPages: "页面",
      close: "关闭搜索",
    },
    carousel: {
  ...
  weightManagement: {
    hero: {
      ...
      description:
        "结合处方药物的结构化、由医生主导的体重管理方案——并配以营养指导与定期监测。每一份方案均从完整咨询开始,费用亦于咨询时说明确认。",
    },
    eligibility: {
      eyebrow: "适合您吗?",
      title: "适用对象",
      lead: "此类药物均须医生处方。您的医生将于咨询时确认您是否符合条件。",
      items: [
        {
          title: "BMI 达 30 或以上",
          description: "属肥胖范围的成人(BMI ≥30 kg/m²)。",
        },
        {
          title: "BMI 27 以上并伴随相关病症",
          description:
            "属超重范围(BMI ≥27 kg/m²)且伴有高血压、高胆固醇、糖尿病前期/糖尿病或睡眠呼吸中止症的成人。",
        },
        {
          title: "愿意配合生活方式调整",
          description:
            "须配合低热量饮食与增加运动量一同进行——并非单靠药物即可见效。",
        },
      ],
    },
    options: {
      ...
      items: [
        {
          ...
          points: [
            "注射于腹部、大腿或上臂皮下,并每周轮换注射部位",
            "每周固定同一天注射",
            "未开封笔针须冷藏保存(2–8°C),避免阳光直射,切勿冷冻",
            "每次注射均须使用新针头",
          ],
        },
        {
          ...
          points: [
            "起始剂量通常为每日一次 3 毫克,连续 30 天后再作调整",
            "每天早晨空腹服用,并以半杯或更少的白开水送服",
            "服药后至少等待 30 分钟,才可进食、饮水或服用其他药物",
            "药片须整颗吞服——不可分半、压碎或咀嚼",
          ],
        },
      ],
    ...
    timeline: {
      ...
      steps: [
        {
          period: "第 1–2 周",
          body: "食欲开始下降;身体适应期间可能出现轻微恶心。",
        },
        {
          period: "第 3–5 周",
          body: "用餐时更快感到饱足,食物渴望减少,份量控制也更容易。",
        },
        {
          period: "第 6 周起",
          body: "体重下降更为明显,对饥饿感与零食摄取的控制力也随之提升。",
        },
      ],
    },
    safety: {
      eyebrow: "安全与监测",
      title: "全程用心照护",
      lead: "副作用通常轻微,并会随时间改善。我们会密切监测您的状况,尤其是治疗最初几周。",
      columns: [
        {
          title: "常见副作用",
          items: ["恶心", "食欲下降", "腹胀", "便秘", "腹泻"],
        },
        {
          title: "缓解恶心的小技巧",
          items: [
      ...
      notes: [
        "建议在开始治疗前进行基础血液检查(血糖、肾功能、肝功能、胆固醇,必要时加验甲状腺功能)。",
        "孕妇不适用;有胰腺炎病史、严重肠胃疾病,或本人/家族有甲状腺髓样癌或 MEN2 综合征病史者亦不适用。",
        "我们每 2–4 周为您检视体重、副作用与进展。",
      ],
    },
    cta: {
      title: "想知道这是否适合您?",
      lead: "预约与我们的医生咨询——我们将评估您的适用性、说明各项方案,并共同制定监测计划。",
    },
  },
  contact: {
    hero: {
